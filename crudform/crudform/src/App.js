...
function App() {
  ...
  useEffect(() => {
    ...
    //Json parse is used to convert string data in javascript on objects
    if (getFromLocal) {
      // The if condition in the code is checking whether the localData variable has a truthy value. In JavaScript,
      // a truthy value is one that evaluates to true when used in a boolean context.
...
// add disable so it will become grey.
//do same for email id.